...
struct concat_traits {
    ...
    typedef decltype((std::declval<collection_selector_type>())(std::declval<source_value_type>())) collection_type;
...
//#endif
    ...
    typedef decltype((std::declval<result_selector_type>())(std::declval<source_value_type>(), std::declval<collection_value_type>())) value_type;
};
